...
//        player.url = URL(string: "https://www.apple.com/105/media/cn/mac/family/2018/46c4b917_abfd_45a3_9b51_4e3054191797/films/bruce/mac-bruce-tpl-cn-2018_1280x720h.mp4")
        if let path = Bundle.main.path(forResource: "190204084208765161.mp4", ofType: nil) {
...
@objc private extension CLViewController {
    func changeAction() {
        ...
        let arr = ["http://vfx.mtime.cn/Video/2019/03/09/mp4/190309153658147087.mp4", "https://gxbwap.pluss.cn/upload/75d31b0abd384af0bd7f53a39b57f425.mp4", "https://www.apple.com/105/media/cn/mac/family/2018/46c4b917_abfd_45a3_9b51_4e3054191797/films/bruce/mac-bruce-tpl-cn-2018_1280x720h.mp4", "http://www.ebookfrenzy.com/ios_book/movie/movie.mov"]
        player.url = URL(string: arr[Int(arc4random_uniform(4))])
        player.play()
    }
}
